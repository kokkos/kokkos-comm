...
function(kokkoscomm_add_cxx_flags)
    ...
    if(CXX_HAS_CAST_ALIGN)
        target_compile_options(${ADD_CXX_FLAGS_TARGET} ${TARGET_COMPILE_OPTIONS_KEYWORD} -Wcast-align)
    endif()
    if(CXX_HAS_WFORMAT2)
        target_compile_options(${ADD_CXX_FLAGS_TARGET} ${TARGET_COMPILE_OPTIONS_KEYWORD} -Wformat=2)
    endif()
    if(CXX_HAS_WMISSING_INCLUDE_DIRS)
        target_compile_options(${ADD_CXX_FLAGS_TARGET} ${TARGET_COMPILE_OPTIONS_KEYWORD} -Wmissing-include-dirs)
    endif()
